...
const Home = () => {
  return (
    <div name="home" className="w-full h-screen bg-[#04705C]">
      {/* Container */}
      <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
        ...
        <h2 className="text-4xl sm:text-5xl font-bold text-[#09C9A4]">
          Dashboard para Representação do Estado de Saúde de Doentes Com Patologias Respiratórias
        </h2>
        <p className="text-[#b9fff2] py-4 max-w-[700px]">
        ...
        <div>
          <button className="text-[#E7ECEF] group border-2 px-6 py-3 my-2 flex items-center hover:bg-[#06a689] hover:border-[#06a689]"><Link to="publications" smooth={true} duration={500}>
